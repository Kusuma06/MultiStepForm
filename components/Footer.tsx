  ...
  return (
    ...
    >
      ...
      {step > 1 && (
        <Button
          variant="ghost"
          className="text-c-neutral-cool-gray hover:text-c-primary-marine-bluehover::bg-c-primary-purplish-hover"
      ...
      <Button
        className={cn(
          "bg-c-primary-marine-blue hover:bg-c-primary-marine-blue-hover",
          {
